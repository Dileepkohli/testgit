      ...
      <div className='p-3' >
            ...
            <Paper className='card ms-2' elevation={3}  style={{marginLeft:-20,borderRadius:20}}>
              ...
              <div className='d-flex' style={{marginTop:-20}}>
                <div className='p-2 ' style={{marginLeft:10}} >
                    {
                  ...
                  <div className='p-4' style={{marginTop:50,}}><button className='btn btn-primary ' style={{borderRadius:20,marginLeft:30,height:36}}>Pending</button></div>
              </div>
              <div className='p-4' style={{marginTop:-20,color:'CaptionText'}}>
                <p style={{textAlign:'justify',marginLeft:5,width:515}}>{this.props.EachItemData.card_data}</p>
