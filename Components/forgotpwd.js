        ...
        {isForgot &&
          <div className='col-md-7  col-md-6 col-12 p-4 justify-content-end align-items-center'>
            ...
            <div className=' ps-5 pt-5 pb-5 '>
              ...
              <p style={{ fontWeight: 'bold' }}>Please Enter The 4 Digit  Code  Send To Your Email </p><br />
          ...
          <div className='col-md-7  col-md-6 col-12 p-4 justify-content-end align-items-center'>
            ...
            <form className='p-3' onSubmit={formik.handleSubmit} >
              <div className=' ps-5 pt-5 pb-5 '>
                ...
                <TextField type='password' id="standard-basic" label="Enter  Newpassword" name='newpassword' onChange={formik.handleChange} value={formik.values.newpassword} placeholder='Enter your Password' variant="standard" fullWidth required /><br /><br />

                <TextField type='password' id="standard-basic" label="Confirm  Newpassword" name='confirmNewpassword' onChange={formik.handleChange} value={formik.values.confirmNewpassword} placeholder='Enter your Password' variant="standard" fullWidth required /><br /><br />
