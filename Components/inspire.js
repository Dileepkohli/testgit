                    ...
                    <div className='p-4'>
                        ...
                        <form className='pt-4' onSubmit={formik.handleSubmit}>
                            <Paper className='p-5 ' elevation={18}>
                                <TextField id="standard-basic" variant="standard" type='text' name='title' label='Title of the Blog' value={formik.values.title} onChange={formik.handleChange} required fullWidth /><br /><br />
                                <TextField id="standard-basic" variant="standard" type='text' name='blog' label='Write here' value={formik.values.blog} onChange={formik.handleChange} fullWidth required /><br /><br /><br />
